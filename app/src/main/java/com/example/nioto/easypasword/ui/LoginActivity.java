...
import com.example.nioto.easypasword.util.FingerprintHandler;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public static final String KEY_NAME = "EASYPASSWORD_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!fingerprintManager.isHardwareDetected())
            Toast.makeText(this, "Fingerprint authentication permission enable", Toast.LENGTH_SHORT).show();
        else {
